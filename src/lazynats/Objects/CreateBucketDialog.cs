...
// Multi-field modal for creating an OBJ bucket - mirrors Values/CreateBucketDialog.cs's shape
...
// failed CreateObjectStoreAsync (see ObjectsTab).
internal sealed class CreateBucketDialog: Dialog<NewBucketOptions>
{
    ...
    // above. See Values/CreateBucketDialog's identical override for the full rationale - left
    ...
    private static void SetFieldValidity(TextField field, bool valid) =>
        ...
        // PatternDialog/HeaderDialog/Values/CreateBucketDialog).
