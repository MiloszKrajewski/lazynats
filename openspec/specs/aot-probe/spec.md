# aot-probe Specification

## Purpose
TBD - defines the AOT (Ahead-of-Time compilation) verification probe project used to validate that `lazynats`'s dependencies (NATS client, Rx, DI container) work correctly under Native AOT publish, in isolation from the main application.
